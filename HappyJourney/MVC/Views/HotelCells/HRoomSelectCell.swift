    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView == collection_adultView || collectionView == collection_childView {
            ...
            if collectionView == collection_adultView {
                ...
                // un-select color...
                if indexPath.row >= 4 {
                    cell.lbl_number.textColor = .secInteraciaBlue// UIColor(red: 0, green: 0, blue: 0, alpha: 0.5)
                }
                ...
                if rModel?.adult_count == (indexPath.row + 1) {
                    ...
                    cell.lbl_number.textColor = .secInteraciaBlue// UIColor(red: 237.0/255.0, green: 28.0/255.0, blue: 35.0/255.0, alpha: 1.0)
                }
            }
            else {
            ...
            if collectionView == collection_childAgeView1 {
                ...
                if rModel?.child_age1 == (indexPath.row + 2) {
                    ...
                    cell.lbl_number.backgroundColor = .secInteraciaBlue// UIColor(red: 237.0/255.0, green: 28.0/255.0, blue: 35.0/255.0, alpha: 1.0)
                }
            }
            else {
