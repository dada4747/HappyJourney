...
//        img_hotel .sd_setImage(with: URL.init(string: hModel.hotel_img!))
        ...
        print(((hModel.hotel_price + hModel.hotel_gst)  * (DCurrencyModel.currency_saved?.currency_value ?? 1.0)).formattedWithSeparator())
        
        lbl_price.text =  String(format: "%@ %@", DCurrencyModel.currency_saved?.currency_symbol ?? "$", ((hModel.hotel_price + hModel.hotel_gst)  * (DCurrencyModel.currency_saved?.currency_value ?? 1.0)).formattedWithSeparator()) //DCurrencyModel.currency_saved?.currency_symbol ?? "$" +  ((hModel.hotel_price + hModel.hotel_gst)  * (DCurrencyModel.currency_saved?.currency_value ?? 1.0)).formattedWithSeparator()//String(format: "%@ %.2f", hModel.hotel_currency, hModel.hotel_price)
