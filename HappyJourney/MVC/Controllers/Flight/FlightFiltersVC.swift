...
//    @IBOutlet weak var view_header: UIView!
    ...
    @IBOutlet weak var transistSlider: UIView!
    // MARK:- sort
...
//        displaySort_information()
    ...
    func displayFilters_information() {
        ...
        rangeSlider2.lowerValue = Double(0)
        rangeSlider2.upperValue = Double(10)
...
//        lbl_priceAmt.text = "\(DFlightFilters.currency_code) \(final_min) - \(DFlightFilters.currency_code) \(final_max)"
    ...
    func addDelegatesAndElements() {
        ...
        // Range slider adding...
        rangeSlider.frame = CGRect.init(x: 0, y: 0, width: (self.view.frame.size.width-50), height: 24)
        
        rangeSlider.thumbBorderWidth = 0
        
        rangeSlider.thumbTintColor = .secInteraciaBlue
        rangeSlider.trackTintColor = UIColor(hexString: "#D8D8D8")
//        rangeSlider.trackHighlightTintColor = defaultColor
        ...
        rangeSlider2.frame = CGRect.init(x: 0, y: 0, width: (self.view.frame.size.width-50), height: 24)
        rangeSlider2.thumbTintColor = UIColor(hexString: "#E28A58")
        rangeSlider2.trackTintColor = UIColor(hexString: "#D8D8D8")
        rangeSlider2.lowerValue = 0
        rangeSlider2.upperValue = 1
        rangeSlider2.addTarget(self, action: #selector(rangeSliderValueChanged(slider:)), for: .valueChanged)
        transistSlider.addSubview(rangeSlider2)
    }
...
//                childView.backgroundColor = UIColor.white
                childView.layer.borderColor = UIColor.clear.cgColor// UIColor(hexString: "#FE9C5E")
