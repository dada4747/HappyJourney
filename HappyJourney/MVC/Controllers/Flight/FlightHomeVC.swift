...
class FlightHomeVC: UIViewController {
    ...
    @IBOutlet weak var mainviewHconstraint: NSLayoutConstraint!
    
    @IBOutlet weak var viewReturnDateHConstraint: NSLayoutConstraint!
    @IBOutlet weak var returnDateViewTopHconstraint: NSLayoutConstraint!
    // dates lables...
    ...
    var sectionNumber = 0
    var topOffer_Array: [DCommonTrendingFlightItem] = []
    ...
    override func viewDidLoad() {
        ...
        DCommonModel.trendingFligh_Array.forEach({ item in
        ...
        // hidden return view...
        viewReturnDateHConstraint.constant = 0
        returnDateViewTopHconstraint.constant = 0
        ...
        tbl_multiCity.frame.size.height = 230
        ...
        displayDepartDest()
        addCities_HConstraint.constant = 190
    ...
    func showOffers(){
        coll_ads.reloadData()
        coll_ads_HContraints.constant = 0
//        if
    ...
    @objc func clearInformationAfterBooking() {
        ...
        addCities_HConstraint.constant = 240
        ...
        addCities_HConstraint.constant = CGFloat(230 * mulityCititesListArray.count)
    ...
    @IBAction func flightTripTypeClicked(_ sender: UIButton) {
        ...
        for childView in view_flightTripType.subviews {
            for childSubView in childView.subviews {
                ...
                if let gradView = childView as? GradientView {
                    gradView.endColor = .white
                    gradView.startColor = .white
                }
                ...
                if childView.tag == sender.tag {
                    ...
                    if let gradView = childView as? GradientView {
                        gradView.startColor = UIColor(hexString: "#E28A58")
                        gradView.endColor = UIColor(hexString: "#D03373")
                    }
                    if let lbl = childSubView as? UILabel {
                        lbl.textColor = .white
                    }
        ...
        if sender.tag == 12 {
            ...
            addCities_HConstraint.constant = CGFloat(240 * mulityCititesListArray.count) // cellhight + no.of cities
            //            mainviewHconstraint.constant =  CGFloat(230 * mulityCititesListArray.count)
            print(addCities_HConstraint.constant)
        } else {
            
            view_oneWayRound.isHidden = false
            addCities_HConstraint.constant = 240 // 295
            print(addCities_HConstraint.constant)
            if sender.tag == 11 {
                DTravelModel.tripType = .Round
                viewReturnDateHConstraint.constant = 70
                returnDateViewTopHconstraint.constant = 10
                addCities_HConstraint.constant = 270 // 295
                ...
                addCities_HConstraint.constant = 190 // 295
    ...
    @IBAction func addCityClicked(_ sender: UIButton) {
        ...
        if valid == true {
            ...
            if mulityCititesListArray.count <= 5 {
                ...
                mulityCititesListArray = DCityModel.createModel()
                tbl_multiCity.reloadData()
                addCities_HConstraint.constant = CGFloat(240 * mulityCititesListArray.count)
                //                mainviewHconstraint.constant =  CGFloat(230 * mulityCititesListArray.count)
                print(addCities_HConstraint.constant)
                tbl_multiCity.reloadData()
            }
...
extension FlightHomeVC:  UICollectionViewDelegate, UICollectionViewDataSource, PinterestLayoutDelegate {
...
//        }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        // cell creation...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "TopFlightCVCell", for: indexPath as IndexPath) as! TopFlightCVCell
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        print(topOffer_Array[indexPath.row])
        let ss = topOffer_Array[indexPath.row]
        let dep = ["airline_id": "",
