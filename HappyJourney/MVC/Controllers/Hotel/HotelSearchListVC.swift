...
//        self.view_hotelSearch.isHidden = true
    ...
    func attributeString(fromSting: String, searchString: String) -> NSMutableAttributedString {
        ...
        final_arribute.addAttribute(NSAttributedString.Key.font,
                                    value: UIFont(name: "Aeonik Bold", size: 14.0) ?? UIFont.boldSystemFont(ofSize: 14.0),
                                    range: rangeVal)
    ...
    @IBAction func filterNameAction(_ sender: Any) {
        ...
        if sortByHotelName {
            ...
            star_rating = [0, 0, 0, 0, 1]
//            sort_number = 5
            self.img_nameFilter.image = UIImage(named: "ic_square_checked")
...
//            sort_number = 4
        star_rating = [0, 0, 0, 0, 0]
            self.img_nameFilter.image = UIImage(named: "ic_square_check")
...
//            cell?.displayHotelAroundTheWorld()
////                cell?.displayTopHotelDestination(dest_array: trendingHotel_Array)
//                cell?.adsType = "Hotels"
//            cell?.bg_view.startColor = UIColor(hexString: "#00BBCA")
//            cell?.bg_view.endColor = UIColor(hexString: "#90DF6F")
//            cell?.bg_view.diagonalMode = true
//            cell?.bg_view.horizontalMode = true
