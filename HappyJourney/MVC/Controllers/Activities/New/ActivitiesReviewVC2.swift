...
class ActivitiesReviewVC2: UIViewController {
...
//            btn_male.backgroundColor = UIColor.primInteraciaPink // UIColor(red: 19/255, green: 25/255, blue: 59/255, alpha: 1.0)
...
//            btn_male.backgroundColor = UIColor(red: 221/255, green: 222/255, blue: 223/255, alpha: 1.0)
            btn_female.startColor = UIColor.secInteraciaBlue
            btn_female.endColor = UIColor.primInteraciaPink
//            btn_female.backgroundColor =  UIColor.primInteraciaPink //UIColor(red: 19/255, green: 25/255, blue: 59/255, alpha: 1.0)
...
//                let multipliedValue3 = (model.taxes ?? 0.0) * Float(Double(value ?? "0.0") ?? 0.0)
...
//            }
    ...
    func validatePromoCodeAPICall(obj: [String: Any]){
        let user_id = ""
        var dict = ["module":"Flight","promo_code":obj["promo_code"] as? String ?? "","convenience_fee":"","email":"","user_id":user_id.getUserId(),"currency":"SAR","total_amount_val":obj["value"] as? String ?? ""]
...
//                                    "name_title": ["1"],
        ...
        let passangerObj: [String: Any] = ["firstName":firstName,"lastName":lastName,"Title": title_value,"Pax_Type":"1"]
...
//        params["BookingQuestions"] = emptyDict
        ...
        CommonLoader.shared.startLoader(in: view)
        // calling apis...
        VKAPIs.shared.getRequestFormdata(params: params, file: Activities_Prebooking, httpMethod: .POST)
        { (resultObj, success, error) in
...
//            lbl_travellerName.text = firstName + " " + lastName
        }
...
extension ActivitiesReviewVC2: UITextFieldDelegate {
...
//    ResultToken = "dae2056670545ab10e6d954d3d25e08e*_*1*_*0FM1bXewvOHwGahv";
//    ResultToken = "dae2056670545ab10e6d954d3d25e08e*_*119*_*Knvq56dDixjKzy3n";
...
extension ActivitiesReviewVC2: PromoCodeSelection{
...
// MARK:- CustomDelegate
extension ActivitiesReviewVC2: CustomDelegate {
...
extension ActivitiesReviewVC2: ISOCodeDelegate {
