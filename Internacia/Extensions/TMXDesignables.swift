...
public class GradientButton: UIButton {
    ...
    @IBInspectable public var startColor: UIColor = .secInteraciaBlue { didSet { updateColors() } }
    @IBInspectable public var endColor: UIColor = .primInteraciaPink     { didSet { updateColors() } }
...
public class GradientView: UIView {
    @IBInspectable var startColor:   UIColor = .primInteraciaPink { didSet { updateColors() }}
    @IBInspectable var endColor:     UIColor = .secInteraciaBlue { didSet { updateColors() }}
